    ...
    : AbstractValidator<CreatePurchaseOkResponsePurchase?>
{
    public CreatePurchaseOkResponsePurchaseValidator()
    {
        ...
        RuleFor(CreatePurchaseOkResponsePurchase => CreatePurchaseOkResponsePurchase.StartDate)
            .NotNull()
            .WithMessage("Field startDate is required and cannot be null.");
        RuleFor(CreatePurchaseOkResponsePurchase => CreatePurchaseOkResponsePurchase.EndDate)
            .NotNull()
